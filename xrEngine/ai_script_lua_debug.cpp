...
bool Script::bfPrintOutput(lua_State* tpLuaVirtualMachine, LPCSTR caScriptFileName, int iErorCode)
{
    for (int i = -1;; --i)
...
void Script::vfPrintError(lua_State* tpLuaVirtualMachine, int iErrorCode)
{
    switch (iErrorCode)
    {
    case LUA_ERRRUN:
...
bool Script::bfListLevelVars(lua_State* tpLuaVirtualMachine, int iStackLevel)
{
